...
~~~
This will load the docker container as an image, please note this will take some time (**could be 3~12 min**).
...
You can "run" the robot by pressing the triangle at the left bottom. Closing the gz sim gui will bring you back to the text window. You can exit the container by "exit".
...
### END OF THIS MD...
For the next step:  
[2_Building our first robot](./2_Building_our_first_robot.md)
