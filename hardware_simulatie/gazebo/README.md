...
fig, (ax_level, ax_plot) = plt.subplots(
    1, 2,
    figsize=(10, 6)
)
...
ax_level.set_title(
    "Level System (Click to change setpoint)"
)
...
line_level, = ax_plot.plot(
    [],
    [],
    label="Level"
)

line_sp, = ax_plot.plot(
    [],
    [],
    '--',
    label="Setpoint"
