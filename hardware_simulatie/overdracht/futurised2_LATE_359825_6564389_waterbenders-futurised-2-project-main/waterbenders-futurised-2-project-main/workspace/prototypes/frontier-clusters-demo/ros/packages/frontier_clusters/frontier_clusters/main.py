...
class FrontierExploration(Node):
    ...
    def map_callback(self, msg: OccupancyGrid):
        ...
        self.cluster_frontiers(frontiers, occupancy_grid)

        # Temporarily disables due to clustering being too heavy computationally
        ...
        self.get_logger().info(f'cluster_frontiers took {elapsed:.3f}s')
            ...
            for ix in range(width):
                ...
                if grid[iy, ix] == 0:
                    ...
                    for ni, _ in neighbours:
                        ...
                        # haven't already been added to 'frontiers' (avoids duplicates)
                        if grid[ni] == -1 and index_pair not in frontiers:
                            frontiers.append(index_pair)
                            break

        return frontiers

    def cluster_frontiers(self, frontiers, grid):
    ...
    def draw_map(self):
        ...
        if self.clusters_:
            for cluster in self.clusters_:
                ...
                self.ax.scatter(x, y, s=5, c='lime', alpha=0.5)
