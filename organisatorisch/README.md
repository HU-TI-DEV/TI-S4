...
Net als binnen S3 staat voor de beoordeling in S4 een **verantwoordingsdocument** met **[portfolio items](../Portfolio-items.md)** centraal. Op de pagina [Portfolio Items en Feedback](./portfolio_items_en_feedback.md) wordt uitgelegd hoe je binnen S4 aan portfolio items kunt komen via een één-tweetje tussen je persoonlijke repo en Canvas.
